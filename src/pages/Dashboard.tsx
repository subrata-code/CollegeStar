...
const Dashboard = () => {
  ...
  const profileCompletion = (user as any)?.user_metadata?.profileCompletion as number | undefined;
          ...
          <Card className="mb-8 border-dashed">
            <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <div>
                ...
                <CardDescription>
                  {Math.max(profileCompletion || 0, 0)}% complete — finish your profile to unlock tailored recommendations
                </CardDescription>
              </div>
